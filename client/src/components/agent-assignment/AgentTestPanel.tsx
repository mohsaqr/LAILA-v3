...
export const AgentTestPanel = ({ assignmentId, config }: AgentTestPanelProps) => {
  ...
  const startConversationMutation = useMutation({
    mutationFn: () => agentAssignmentsApi.startTestConversation(assignmentId, config.id),
    onSuccess: (data) => {
    ...
    return (
      <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-lg border border-violet-200 p-8 text-center">
        ...
        <p className="text-gray-600 mb-6 max-w-md mx-auto">
          Start a test conversation to see how your agent responds. You can have multiple
          test conversations to refine your agent's behavior.
        </p>
        <Button
