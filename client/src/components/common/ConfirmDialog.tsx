...
interface ConfirmDialogProps {
  ...
  loading?: boolean;
  /**
   * When true, the confirm button must be clicked twice: the first click
   * reveals a final "this cannot be undone" warning and only the second
   * click fires `onConfirm`. Defaults to false so existing callers keep
   * their single-step behavior unchanged.
   */
