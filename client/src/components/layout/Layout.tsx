...
export const Layout = () => {
  ...
  const sidebarPages = ['/dashboard', '/courses', '/course', '/ai-tools', '/ai-tutors', '/settings', '/profile', '/teach', '/labs', '/forums', '/certificates', '/certificate', '/quizzes', '/admin', '/reports', '/surveys'];
